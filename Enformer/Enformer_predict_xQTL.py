...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Classification models (RF/XGB/L1/ElasticNet) + cross-validation on Enformer outputs; optional save/predict workflow."
    )
    p.add_argument(
        "--mode",
        type=str,
    ...
    p.add_argument("--model", type=str, choices=["rf", "xgb", "l1", "enet"], default="rf",
                   help="Model to use: rf, xgb, l1 (L1 logistic), enet (elastic-net logistic).")
