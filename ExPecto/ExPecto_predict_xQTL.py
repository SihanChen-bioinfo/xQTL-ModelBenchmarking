...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--model",
        type=str,
        choices=["xgb", "rf", "l1", "enet", "svm"],
        default="xgb",
        help="Classifier family: xgb, rf, l1 (L1 logistic), enet (elastic-net logistic), svm (SVC). Model-specific hyperparameters come from internal defaults plus auto-tune outputs.",
    )
